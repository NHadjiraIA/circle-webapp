...
import {DASHBOARD, LOGIN, PAGE1,AUTH_PAGE1, ROOT, TEST, HADJIRA} from "navigation/CONSTANTS";
...
export const NavLinks = () => {
  return (
    <>
      ...
      <LinkRoute to={TEST}>this a test</LinkRoute>
      <LinkRoute to={HADJIRA}>Hadjira's page</LinkRoute>
    </>
  );
};
